    ...
    <div className="flex-1">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            An AI-powered agricultural advisory platform designed for Indian
            farmers. We provide timely, localized guidance in Hindi to help you
            make confident, data-driven decisions on your farm.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              disease detection to weather-aware planning, we strive to bring a
              helpful Krishi Officer to every farmer’s pocket.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-muted-foreground text-sm">
                Ask questions in Hindi and get natural, easy-to-follow answers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div
              ...
              style={{ transitionDelay: "300ms" }}
            >
              <span className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-primary/10 text-primary font-semibold mb-4">
                1
              </span>
      ...
      <section
        ref={ctaRef}
        className="py-24 bg-gradient-to-r from-primary/5 via-primary/10 to-primary/5"
      >
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            <Link
              href="/register"
              className="group bg-primary text-primary-foreground px-8 py-4 rounded-xl text-lg font-semibold hover:bg-primary/90 transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Create Your Account
